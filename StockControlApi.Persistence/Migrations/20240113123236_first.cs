    ...
    public partial class first : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserPushNotificationsId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PushNotifications", x => x.UserPushNotificationsId);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecipientUserId = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    IsVisualized = table.Column<bool>(type: "tinyint(1)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductName = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    PriceUnit = table.Column<double>(type: "double", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Movemments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Movemments_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Movemments_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Movemments_ProductId",
                table: "Movemments",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_Movemments_UserId",
                table: "Movemments",
                column: "UserId");
